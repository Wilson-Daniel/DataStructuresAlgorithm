...
public class TWO_D_ARRAY_SPIRAL_Fill_matrix_AntiCloclWise {

    //FILL MATRIX ANTI-CLOCKWISE

    public static void main(String[] args) {
        int[][] matrix = antiClockSpiral(5);
        printArrays(matrix,5);
    }
    public static int[][] antiClockSpiral(int n){
